...
Formal author/citation details: see `CITATION.cff` and `PROVENANCE_DOI_AND_ATTRIBUTION.md`.
...
This is the public GitHub working copy and discovery anchor for the MKUFT canon stack.

MKUFT is a theoretical unified-field and coherence framework. It organises the work through substrate, information, physical expression, and observer/coherence-boundary dynamics.

The active layer convention is:
...
1. `START_HERE_PUBLIC_OVERVIEW.md` — plain-English overview.
...
Use the formal citation metadata in `CITATION.cff` and `PROVENANCE_DOI_AND_ATTRIBUTION.md`.

## Exact public search phrase
