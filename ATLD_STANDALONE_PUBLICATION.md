...
- Commercial exercise of the copyright rights licensed in the manuscript requires separate written permission from the author.
- Adaptations shared under the public licence must use the same licence.
- No software licence, patent licence, trademark licence, certification licence, or commercial-implementation licence is granted by the manuscript.

The licence applies to the exact licensed manuscript. It does not automatically license separate source-module files, later GitHub revisions, later companion modules, source code, datasets, benchmarks, implementation manuals, or other material not included in that manuscript.
