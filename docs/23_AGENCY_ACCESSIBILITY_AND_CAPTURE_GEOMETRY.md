...
One ordinary retention-pressure mechanism is **status or self-image cost**. A person, group, institution, or model may experience correction not only as a change of belief or action but as a threatened loss of standing, authority, competence, coherence, face, ownership, or prior commitment. Status can also be a legitimate information-bearing prior where it tracks demonstrated expertise, reliability, or custody; the relevant question is whether the status cue is being used at the address it actually earns.
