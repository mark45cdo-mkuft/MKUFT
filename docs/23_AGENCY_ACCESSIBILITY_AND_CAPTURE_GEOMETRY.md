...
The capacity may survive while its interface is degraded.
...
Capture is a post-boundary structure.
...
- false attribution;
- identity fusion;
- installed attractors;
- damaged action maps;
- mislabelled exits;
- distorted cost and value estimates.
...
- separating self from installed impulse;
- reducing material dependency;
- creating low-cost trial exits;
...
It is not a substitute for clinical, legal, safeguarding, or domain-specific assessment.
