...
**Role:** distinguish retained capacity from practical access and model how action maps may be narrowed, corrupted, or restored.
...
The model may be applied cautiously to coercive control, abusive relationships, addiction, cultic systems, extremist recruitment, institutional capture, propaganda, trauma loops, learned helplessness, compulsive behaviour, organisational obedience, adversarial human–AI interaction, and identity-based manipulation.
...
The model also fails if it becomes merely a label for disagreement. Ordinary disagreement, loyalty, faith, duty, and sacrifice cannot be erased by calling them capture, and reduced accessibility does not imply zero moral agency.
