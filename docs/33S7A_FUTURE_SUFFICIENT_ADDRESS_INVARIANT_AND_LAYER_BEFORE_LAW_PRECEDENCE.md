...
**Status:** canonical nomenclature and precedence note. This module names an already-public construction; it does not retroactively alter a frozen publication, assert a new mathematical theorem, or claim experimental confirmation of a universal law of nature.
...
The scientific content precedes these names. The names are introduced here to make the already-existing object unambiguous, citable and traversable.
...
2. **FSAI** is the canonical name now assigned to that cross-domain formal criterion;
3. **LBLP** is the canonical name now assigned to its Layer-Before-Law methodological precedence consequence;
4. neither name upgrades the construction to an experimentally confirmed universal law.

Any stronger law-of-nature claim requires prospective quantitative success, appropriate ordinary baselines, independent replication and the promotion gates already present in the public canon.
...
LBLP:
When that closure fails, test and minimally repair the Address before treating the failure as evidence for a changed governing law.
