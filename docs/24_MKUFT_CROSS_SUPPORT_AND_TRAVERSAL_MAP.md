...
- each major claim has a layer address;
...
Carries nodes, transitions, cost, coherence, observer discipline, and falsifier order.
...
Carries test design, null models, effect size, pre-registration, worked calculation, and failure conditions.
...
Carries threshold, boundary, geometry, layer addressing, and physical reduction rules.
...
Depends on possibility space, transition cost, information routing, observer interpretation, and falsification.
...
Depends on S–I–P–O, layer-specific evidence, units, coupling, and reduction rules.

Supports LUCY, OCQS, group coherence, physical bridges, and future module design.
...
| `08_LUCY_BOUNDARY_THRESHOLD_FRAMEWORK.md` | Threshold vocabulary | Boundary and coherence | Layer addressing and gradient mechanics | Operational threshold and ordinary domain models |
...
| `16_GRADIENT_MECHANICS_BOUNDARY_SHEAR_GEOMETRY.md` | Boundary-physics hypothesis | LUCY and math | Controlled geometry/orientation tests | Ordinary mechanics, systematics, reproducibility |
...
5. Define variables only where they improve discrimination.
...
- mathematical expressions are labelled as hypotheses, templates, or validated models accurately;
