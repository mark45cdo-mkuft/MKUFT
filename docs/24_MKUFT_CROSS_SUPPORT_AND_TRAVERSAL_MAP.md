...
MKUFT contains several kinds of public document: foundational proposals, mathematical scaffolds, experimental programmes, falsifiers, explanatory bridges, and applied research branches. This map shows how those public objects support and constrain one another.

Its central rule is:

> A module should be read with the definitions, evidence requirements, ordinary alternatives, and falsifiers that limit its claims.

The map is navigation and dependency structure. It does not create evidence, establish a physical mechanism, or replace the scientific content of the linked modules.
...
[Start Here](../START_HERE_PUBLIC_OVERVIEW.md) → [Integrated Master Spine](../MKUFT_INTEGRATED_MASTER_SPINE.md) → [Canon Map](../CANON_MAP.md) → [Cross-Support Map](24_MKUFT_CROSS_SUPPORT_AND_TRAVERSAL_MAP.md) → [ARTA Engine Construction Map](35_ARTA_ARCHITECTURE_INSTANTIATION_AND_ENGINE_CONSTRUCTION_MAP.md) → [Context-Conditioned State Comparison](31_CONTEXT_CONDITIONED_STATE_COMPARISON_AND_OBSERVABILITY.md) → [Recursive Constraint Closure](32_RECURSIVE_CONSTRAINT_CLOSURE_AND_REACHABLE_STATE_GEOMETRY.md) → [Load-Bearing Relation Sets](32S_LOAD_BEARING_RELATION_SETS_AND_SCALE_TRANSITION_TESTS.md) → [Relational Addressability](32S1_INVARIANT_PERSISTENCE_RELATIONAL_ADDRESSABILITY_AND_SCALE_TRANSITION.md) → [Temporal Continuity](32S2_TEMPORAL_CONTINUITY_KERNELS_AND_MINIMUM_IDENTITY_HORIZON.md) → [Relational Brackets / Completion](32S3_RELATIONAL_BRACKETS_COMPLETION_GEOMETRY_AND_I_TO_P_ADMISSIBILITY.md) → [Intrinsic–Extrinsic Transport](32S4_INTRINSIC_EXTRINSIC_ADDRESS_TRANSPORT_HOLONOMY_AND_BOUNDARY_CONDITIONED_REALISATION.md) → [SIPO Capstone](33_SIPO_CAPSTONE_CONSTRAINT_CONDITIONED_ADDRESSED_UPDATE_LAW.md) → [Dynamic Interface Promotion](33S1_DYNAMIC_INTERFACE_PROMOTION_AND_RECURSIVE_BOUNDARY_CLOSURE.md) → [Relational Closure / Law Descent](33S2_RELATIONAL_CLOSURE_LAW_DESCENT_AND_BIDIRECTIONAL_READDRESSING.md) → [Recoverability](33S3_CROSS_SCALE_PERFORMANCE_RECOVERABILITY_AND_HYSTERETIC_READDRESSING.md) → [Address Sufficiency](33S4_ADDRESS_SUFFICIENCY_PREDICTIVE_CLOSURE_AND_REACHABLE_FUTURE_GEOMETRY.md) → [Rate-Conditioned Addressing](33S5_RATE_CONDITIONED_ADDRESSING_TIME_PARAMETERISED_TRAVERSAL_AND_ADAPTIVE_REORGANISATION.md) → [Addressed Admissible Futures](33S6_ADDRESSED_ADMISSIBLE_FUTURES_RESTORATIVE_REACHABILITY_AND_LOAD_BEARING_FUTURE_GEOMETRY.md) → [Future-Splitting State Recruitment](33S7_FUTURE_SPLITTING_STATE_RECRUITMENT_STATE_ADEQUACY_AND_PROSPECTIVE_MECHANISM_LOCALISATION.md) → [FSAI / Layer-Before-Law Precedence](33S7A_FUTURE_SUFFICIENT_ADDRESS_INVARIANT_AND_LAYER_BEFORE_LAW_PRECEDENCE.md) → [Native Consequence-Cone Stress](28B_NATIVE_CONSEQUENCE_CONE_STRESS_TESTING_AND_RELATION_INFORMATIVE_DEFORMATION.md) → [Minimum Decisive FSAI/FSSR Flagship — HCP Magnesium](28C_FSAI_FSSR_MINIMUM_DECISIVE_FLAGSHIP_HCP_MAGNESIUM_PROTOCOL.md) → [Falsification](05_FALSIFICATION_SUMMARY.md)
...
- [Native Consequence-Cone Stress Testing](28B_NATIVE_CONSEQUENCE_CONE_STRESS_TESTING_AND_RELATION_INFORMATIVE_DEFORMATION.md)
...
These carry controls, preregistration, null models, effect-size discipline, promotion criteria, claim status, replication requirements, and reduction rules. Module 28B adds the target-sufficient native consequence surface for relation-informative deformation. Module 28C is the first full minimum-decisive prospective instantiation of the FSAI/FSSR family: a history-dependent HCP-magnesium protocol with one primary future object, strongest fair native constitutive states, an FSSR challenge versus a matched parameter-information challenge, predeclared minimal physical repair, remove/restore burden, four separately governed verdicts, and explicit null publication. It reports no positive experimental result.
...
These carry addressing, state, flow, perturbation testing, false-positive controls, and the candidate procedural interpretation of the Voynich Manuscript.

### Active traversal and load-bearing structure
...
[Load-Bearing Invariants and Whole-System Deformation](25_LOAD_BEARING_INVARIANTS_AND_WHOLE_SYSTEM_DEFORMATION.md) compares baseline with controlled relation-level deformations. Structural centrality is not truth.
...
[Typed Traversal and Equation Hygiene](27_TYPED_TRAVERSAL_AND_EQUATION_HYGIENE.md) keeps component spaces typed and prevents physical geometry, state-space geometry, information adjacency, observer registration, adaptive construction address, and metaphysical language from being flattened into one mathematical object.

### 30 — LUCY Threshold Geometry and Relational Closure

[LUCY Threshold Geometry and Relational Closure](30_LUCY_THRESHOLD_GEOMETRY_AND_RELATIONAL_CLOSURE.md) is the downstream physical application of the canonical LUCY threshold sequence. The cross-layer coupling may be zero; the branch advances only under ordinary-physics controls and accepted-limit recovery.
...
[Load-Bearing Relation Sets and Scale-Transition Tests](32S_LOAD_BEARING_RELATION_SETS_AND_SCALE_TRANSITION_TESTS.md) makes `load-bearing` an intervention result, distinguishes relation from carrier, and gives a promotion test for an organised lower-scale whole to earn higher-scale effective-unit status.
...
[Temporal Continuity Kernels and Minimum Identity Horizon](32S2_TEMPORAL_CONTINUITY_KERNELS_AND_MINIMUM_IDENTITY_HORIZON.md) extends same-self comparison to recent relational trajectories where history is load-bearing.
...
|---|---|---|
| [01 — Core Extended](01_MKUFT_CORE_EXTENDED.md) | S–I–P–O theory spine | Falsification / ordinary limits |
| [02 — Mathematical Appendix](02_MKUFT_MATH_APPENDIX.md) | Mathematical scaffold | Operational definitions and accepted limits |
| [03 — Formal Addendum](03_STANDALONE_FORMAL_ADDENDUM.md) | State graph, trajectory, cost models | Units, domains, predictive comparison |
| [04 — Experimental Programme](04_EXPERIMENTAL_TEST_PROGRAM.md) | Test design | Controls, preregistration, replication |
| [05 — Falsification](05_FALSIFICATION_SUMMARY.md) | Failure conditions | Null results and simpler explanations |
| [06 — OCQS](06_OCQS_HUMAN_ACTIVATION_LAYER.md) | Observer-state hypothesis | Cognitive baselines / bounded effects |
| [07 — ESRT/ESF Support](07_ESRT_ESF_AND_VOYNICH_SUPPORT.md) | Procedural bridge | Alternative classifications |
| [08 — LUCY](08_LUCY_BOUNDARY_THRESHOLD_FRAMEWORK.md) | Threshold framework | Operational thresholds / ordinary models |
| [09 — Voynich](09_VOYNICH_PROCEDURAL_ENGINE.md) | Candidate application | Linguistic/cipher/scribal/decorative nulls |
| [10 — ESRT/ESF Method](10_ESRT_ESF_METHOD_APPENDIX.md) | Procedural recognition method | Reliability / false positives |
| [11 — Full-Stack Explanation](11_FULL_STACK_CONVERGENCE_PUBLIC_EXPLANATION.md) | Public bridge | Canonical owners control |
| [12 — Individual Reality Cost and Cohesion](12_INDIVIDUAL_REALITY_COST_AND_COHESION.md) | Boundary/cohesion bridge | Analogy is not physical evidence |
| [13 — Physics-Facing Explanation](13_PHYSICS_FACING_MKUFT_EXPLANATION.md) | Technical translation | Accepted-physics recovery |
| [14 — Worked Examples](14_WORKED_EXAMPLES_RNG_AND_ENVIRONMENT.md) | Numerical illustration | Statistics / replication |
| [15 — Symbolic Physics](15_PARADOXES_FREQUENCY_ATOMS_AND_SYMBOLIC_PHYSICS.md) | Symbolic/physics bridge | Metaphor/model/evidence separation |
...
| [20A — GRACE Formal Route Selection](20A_GRACE_FORMAL_ROUTE_SELECTION_AND_NON_DOMINATED_FUTURE_PRESERVATION.md) | Hard-gated typed route comparison and non-dominated preservation | No universal moral scalar; candidate-set coverage, hard boundaries, and domain-native coordinates remain explicit |
...
| [23A — Recursive Exceptionalism / Epistemic Firewall](23A_RECURSIVE_EXCEPTIONALISM_SELF_SEALING_AUTHORITY_AND_EPISTEMIC_FIREWALL.md) | Self-sealing status/authority-transfer audit | Not a clinical scale, deception detector, spiritual ranking, or ontology proof |
...
| [25A1 — Traversal Coherence Anchor Nomenclature](25A1_TRAVERSAL_COHERENCE_ANCHOR_NOMENCLATURE_REFINEMENT.md) | Umbrella terminology for node/distributed anchor candidates | Does not lower the Module 25A evidence threshold or rewrite frozen publications |
| [25B — ATLD 2 Residual Measurement Audit](25B_ATLD2_RESIDUAL_COORDINATE_MEASUREMENT_AND_SELF_AUDIT.md) | Long-horizon residual-coordinate measurement and self-audit | Does not create a twelve-dimensional ontology or replace 24A/24B/25; frozen ATLD 2 remains separate |
| [25C — Residual Instrument Generation / Protected Discovery](25C_RESIDUAL_INSTRUMENT_GENERATION_AND_PROTECTED_DISCOVERY_BOUNDARY.md) | Residual ownership, instrument refinement, and reproducibility/disclosure boundary | No new ontology; reproducibility burden does not require unrelated private implementation disclosure |
| [25D — Chain-Address Invariants / Packet Transport](25D_CHAIN_ADDRESS_INVARIANTS_LONG_FORM_COHESION_AND_BIDIRECTIONAL_PACKET_TRANSPORT.md) | Verified-chain compression, cold reconstruction, and typed bidirectional transport | Generality remains prospective; no new physical law or primitive |
...
| [27 — Typed Hygiene](27_TYPED_TRAVERSAL_AND_EQUATION_HYGIENE.md) | Mathematical/traversal discipline | Cannot replace branch-specific dynamics |
| [28 — Promotion Gates](28_MKUFT_DISCRIMINATING_EXPERIMENTS_AND_PROMOTION_GATES.md) | Evidence-tier control | Locked discriminators |
| [28A — Cross-Domain Bell/CHSH Calibration](28A_CROSS_DOMAIN_COMPOSITIONAL_SCHEMA_BELL_CHSH_CALIBRATION.md) | Known-answer calibration of cross-domain compositional behaviour | Physical Phase-0 residual remains NULL; no independent new-physics claim |
| [28B — Native Consequence-Cone Stress Testing](28B_NATIVE_CONSEQUENCE_CONE_STRESS_TESTING_AND_RELATION_INFORMATIVE_DEFORMATION.md) | Target-sufficient native relation-deformation environment | Reports no positive empirical result; cone is an experimental-design object, not a new causal geometry |
| [28C — Minimum Decisive FSAI/FSSR HCP Magnesium Protocol](28C_FSAI_FSSR_MINIMUM_DECISIVE_FLAGSHIP_HCP_MAGNESIUM_PROTOCOL.md) | Design-closed flagship protocol for prospective state-sufficiency/challenge testing | Empirical status OPEN; no positive result, new force, or completed unification reported |
| [28D — Evidence Semantics / Claim Promotion](28D_EVIDENCE_SEMANTICS_AND_CLAIM_PROMOTION_GUARD.md) | Keeps evidence, discrimination, mechanism, replication and proof separately typed | Lower-stage evidence is neither erased by an unmet higher gate nor inflated into proof |
| [28E — Detectability-Conditioned Negative Evidence](28E_PRESERVATION_SEARCH_GEOMETRY_AND_DETECTABILITY_CONDITIONED_NEGATIVE_EVIDENCE.md) | Conditions non-detection on preservation, access, coverage, sensitivity and false-negative structure | Weak detectability weakens a null but does not support the missing object |
| [29 — Claim Discipline](29_MKUFT_SCIENTIFIC_TIGHTENING_AND_CLAIM_DISCIPLINE.md) | Claim-status discipline | Architecture/evidence/mechanism stay distinct |
| [29A — Branch Lineage / Generator Accountability](29A_BRANCH_LINEAGE_GENERATOR_ACCOUNTABILITY_AND_ANTI_HYDRA_DISCIPLINE.md) | Tracks failed branches, repairs, search cost and correlated descendants at generator level | Local merit may survive; correlated descendants are not independent wins |
| [29B — Typed Decomposition / Prospective Generator Audit](29B_TYPED_DECOMPOSITION_RECONSTRUCTION_AND_PROSPECTIVE_GENERATOR_AUDIT.md) | Cross-owner decomposition/reconstruction map and prospective strongest-baseline generator test | Broad method claims must survive prospective comparison; inherited generic prior art is subtracted |
| [30 — LUCY Threshold Geometry](30_LUCY_THRESHOLD_GEOMETRY_AND_RELATIONAL_CLOSURE.md) | Downstream effective-geometry hypothesis | Conventional closure / accepted limits |
| [31 — Context-Conditioned State Comparison](31_CONTEXT_CONDITIONED_STATE_COMPARISON_AND_OBSERVABILITY.md) | Comparison/observability discipline | Context cannot immunise claims |
| [32 — Recursive Constraint Closure](32_RECURSIVE_CONSTRAINT_CLOSURE_AND_REACHABLE_STATE_GEOMETRY.md) | Adaptive constraint/reachable-state geometry | Fixed-space/null alternatives |
| [32A — Module 32 Novelty Audit](32A_MODULE_32_NOVELTY_AUDIT_AND_CONTRIBUTION_BOUNDARY.md) | Prior-art/residual-contribution boundary | Novelty reduced by earlier equivalents |
| [32S — Load-Bearing Relation Sets](32S_LOAD_BEARING_RELATION_SETS_AND_SCALE_TRANSITION_TESTS.md) | Relation load / scale promotion | Ablation/substitution / capability tests |
| [32S1 — Relational Addressability](32S1_INVARIANT_PERSISTENCE_RELATIONAL_ADDRESSABILITY_AND_SCALE_TRANSITION.md) | Persistence/addressability/identity parity | Same substrate/name ≠ same-self proof |
...
| [33S2 — Relational Closure / Law Descent](33S2_RELATIONAL_CLOSURE_LAW_DESCENT_AND_BIDIRECTIONAL_READDRESSING.md) | Property-relative higher-address law sufficiency and bidirectional readdressing | Higher-level closure does not grant universal dynamical autonomy |
| [33S3 — Cross-Scale Performance / Recoverability](33S3_CROSS_SCALE_PERFORMANCE_RECOVERABILITY_AND_HYSTERETIC_READDRESSING.md) | Separates local performance, enclosing closure, law sufficiency and target-relative recovery | Local gain does not imply whole-system health; recovery is conditional, not presumed |
| [33S4 — Address Sufficiency](33S4_ADDRESS_SUFFICIENCY_PREDICTIVE_CLOSURE_AND_REACHABLE_FUTURE_GEOMETRY.md) | Target-relative state/address sufficiency and predictive closure | Added coordinates must earn held-out or interventional load |
| [33S4A — Transfer-Conditioned Address Sufficiency](33S4A_TRANSFER_CONDITIONED_ADDRESS_SUFFICIENCY_STATE_ALIASING_AND_COLD_REEMBEDDING.md) | Re-tests inherited state compression after material regime transfer | Domain shift itself is not novel; failed transfer does not imply a new law |
| [33S5 — Rate-Conditioned Addressing](33S5_RATE_CONDITIONED_ADDRESSING_TIME_PARAMETERISED_TRAVERSAL_AND_ADAPTIVE_REORGANISATION.md) | Tests rate/dwell/schedule as target-relative address coordinates | Timing variables remain only when fuller ordinary state does not close the residual |
| [33S6 — Addressed Admissible Futures](33S6_ADDRESSED_ADMISSIBLE_FUTURES_RESTORATIVE_REACHABILITY_AND_LOAD_BEARING_FUTURE_GEOMETRY.md) | Future-equivalence, restorative reachability, reserve, and future-load relation geometry | Present viability is not restoration; frozen AAF publication remains separate |
| [33S7 — Future-Splitting State Recruitment](33S7_FUTURE_SPLITTING_STATE_RECRUITMENT_STATE_ADEQUACY_AND_PROSPECTIVE_MECHANISM_LOCALISATION.md) | Prospective challenge assay for hidden state inadequacy and minimal typed repair | Requires independent continuation, strong native nulls, and physical confirmation before mechanism language |
| [33S7A — Future-Sufficient Address Invariant / LBLP](33S7A_FUTURE_SUFFICIENT_ADDRESS_INVARIANT_AND_LAYER_BEFORE_LAW_PRECEDENCE.md) | Canonical future-sufficiency naming, probe/state separation, and boundary-claim sufficiency | No new mechanism or universal law; frozen publication/evidence boundaries remain |
| [33S7B — Sideways Invariant Interrogation](33S7B_SIDEWAYS_INVARIANT_INTERROGATION_AND_NUISANCE_QUOTIENT.md) | Target-preserving nuisance cancellation / quotient / invertible interrogation route | Does not claim novelty for invariance/quotients and cannot remove every hidden coordinate |
| [33S7C — Observer-Bounded Traversal](33S7C_OBSERVER_BOUNDED_TRAVERSAL_WAKE_SCREENING_AND_REACHABLE_DISCRIMINATOR_FRONTIERS.md) | Bounded observer/readout access, wake screening, representation-conditioned reach and discriminator frontier | No observer-caused physics, hidden-memory substance, consciousness proof, or universal question operator |
| [33A — Law Descent / Recoverability Novelty Audit](33A_LAW_DESCENT_AND_RECOVERABILITY_NOVELTY_AUDIT.md) | Hostile prior-art subtraction and residual-contribution audit for 33S2/33S3 | Positioning/audit only; not exhaustive priority proof or empirical promotion |
| [34 — Research Object Identity / Release Integrity](34_RESEARCH_OBJECT_IDENTITY_RELEASE_INTEGRITY_AND_REPRODUCIBILITY.md) | Release/object identity and reproducibility | Exact version/carrier custody; does not validate science |
| [35 — ARTA Engine Construction Map](35_ARTA_ARCHITECTURE_INSTANTIATION_AND_ENGINE_CONSTRUCTION_MAP.md) | Implementation/instantiation map | Must preserve owner boundaries, NULLs, authority, provenance, and domain-native burden; no certification or software-licence implication |
...
Module 35 is the builder-facing implementation route. It may point to the single public stewardship/use owner for rights routing, but it does not duplicate licence policy or expose non-public implementation state.
