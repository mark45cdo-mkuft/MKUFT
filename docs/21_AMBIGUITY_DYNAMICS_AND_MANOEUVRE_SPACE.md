...
> Ambiguity preserves possibilities. Semantics constrains their admissibility. Honest boundary specification may contract false manoeuvre space while preserving a genuine unresolved exterior. Operational closure can stabilise a target or decision without erasing residual state ambiguity. Unresolved does not mean established or impossible. Charge, confidence, and closure remain separate. Evidence and lawful constraint contract the space without falsifying the route by which it was crossed.