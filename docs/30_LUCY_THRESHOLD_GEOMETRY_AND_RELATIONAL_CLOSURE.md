...
## A Layer-Before-Law Hypothesis for Local Relational Closure and Emergent Gravitational Behaviour
...
**Status:** public working hypothesis; not a completed physical derivation.
...
The paper states prior art, recovery requirements, discriminating signatures, evidence tiers, and falsifiers.

## 1. Scientific position

Two points are already established or well represented in existing research:
...
These are modelling addresses rather than extra spatial dimensions.

The Layer Before Law proposal is that a law observed at $P$ may be the effective regularity of a deeper relational condition rather than the final primitive rule. The ordinary-physics limit remains compulsory.
...
## 4. Prior art and narrow novelty claim
...
The paper distinguishes regimes by observable effect rather than naming two kinds of gravity.

A **localised high-gradient regime** is confined to nuclear, mesoscopic, material, or resonator scales where shell structure, pairing, deformation, collective modes, and boundary conditions may dominate stability.

An **extended effective-geometry regime** is a finite region in which neutral matter, light, and clocks exhibit a common change describable by one effective geometry.

The proposed relation is not a microscopic gravitational wave amplified into macroscopic gravity. It is one state-selection problem expressed differently at different scales.
...
## 7. Neutron-rich superheavy nuclei as a candidate seed class

Superheavy nuclear lifetime is highly configuration-sensitive. Liquid-drop trends favour fission, while shell corrections, pairing, and deformation can raise fission barriers and lengthen lifetimes. The location and lifetime of any island of enhanced stability remain model-dependent.

Terrestrial fusion currently reaches neutron-deficient superheavy isotopes. Astrophysical r-process environments can traverse nuclei far from laboratory access, but survival to long-lived trans-actinide species remains uncertain and depends on poorly known masses, separation energies, beta-decay rates, and fission barriers.

The scientifically permissible statement is:

> Extreme astrophysical environments may create neutron-rich superheavy configurations unavailable to current terrestrial synthesis, and shell effects may produce lifetimes very different from measured neutron-deficient isotopes.

It is not established that such a nucleus controls gravitation. In LUCY, a nuclear state is at most a candidate seed or control variable; the cross-layer coupling is unknown and may be zero.
...
After controlling electromagnetic cavity modes, thermal transport, stress, and mass distribution, threshold or residual should depend on normalised boundary geometry under a declared scaling law.

### Composition and charge

A metric-like effect should couple approximately universally to neutral test bodies. Strong dependence on charge, conductivity, magnetic susceptibility, dielectric constant, or surface finish favours ordinary material effects.

### Wavelength dependence

A metric-like optical-path change should be nearly achromatic in vacuum after dispersion is removed. Strong frequency dependence favours plasma, refractive-index, cavity, or metamaterial mechanisms.

### Clock and phase comparison

At least two independent clock or interferometric methods should show a consistent proper-time or phase residual before an altered-geometry interpretation is promoted.

### Conservation accounting

Any apparent change in inertia, trajectory, or propagation requires complete source-energy, momentum, radiation, heat, and mechanical-reaction accounting. Boundary language is not an exemption from conservation laws.

### Astrophysical signature

If a specific neutron-rich superheavy configuration is required, nuclear-network calculations should predict distinctive fission fragments, decay chains, or abundance residuals in r-process ejecta.
...
1. A. D. Sakharov, “Vacuum quantum fluctuations in curved space and the theory of gravitation,” *Sov. Phys. Dokl.* 12, 1040–1041 (1968), original 1967.
2. T. Jacobson, “Thermodynamics of Spacetime: The Einstein Equation of State,” *Physical Review Letters* 75, 1260–1263 (1995). DOI: 10.1103/PhysRevLett.75.1260.
3. C. Barceló, S. Liberati, and M. Visser, “Analogue Gravity,” *Living Reviews in Relativity* 14, 3 (2011). DOI: 10.12942/lrr-2011-3.
4. T. Padmanabhan, “Emergent Gravity Paradigm: Recent Progress,” *Modern Physics Letters A* 30, 1540007 (2015). arXiv:1410.6285.
5. D. Oriti, “Spacetime as a quantum many-body system,” arXiv:1710.02807 (2017).
6. J. Ben Achour et al., “Quantum Gravity, Hydrodynamics and Emergent Cosmology: A Collection of Perspectives,” arXiv:2411.12628 (2024).
7. T. Damour and G. Esposito-Farèse, “Nonperturbative Strong-Field Effects in Tensor-Scalar Theories of Gravitation,” *Physical Review Letters* 70, 2220–2223 (1993). DOI: 10.1103/PhysRevLett.70.2220.
8. D. M. Siegel, “r-Process nucleosynthesis in gravitational-wave and other explosive astrophysical events,” *Nature Reviews Physics* 4, 306–318 (2022).
